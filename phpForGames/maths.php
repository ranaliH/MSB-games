...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../styles/maths.css"/>
...
<center><h1 class="topic"> Mathamatics.. </h1></center>
...
<center>
	...
	<br><br>
	<img src="../images/maths/mgame1.jpg"> <br><br><br>

<button class="pbutton1 pbutton" type="button" onclick="loadData('gbutton1')" > Play </button>
</center>
...
<img class="simg" src="../images/maths/sgame1.jpg" alt="count with us" > <br><br><br>
<button class="pbutton1 pbutton" type="button" onclick="loadData('gbutton2')" > Count with us </button><br><br><br>
<img class="simg" src="../images/maths/sgame2.jpg" alt="count with us"> <br><br><br>
<button class="pbutton1 pbutton" type="button" onclick="loadData('gbutton3')" > Divide  </button><br><br><br>
<br>
